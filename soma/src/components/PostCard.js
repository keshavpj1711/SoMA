...
export default function PostCard() {
    ...
    const hoverElement = 'flex gap-2 py-2 my-2 hover:bg-socialBlue hover:text-white -mx-4 px-4 rounded-md transition-all hover:scale-110 hover:shadow-md shadow-gray-300'
        ...
        <Card>
            ...
            <div className="flex gap-3">
                ...
                <div className="grow">
                    <p>
                        <Link href={'/profile'}>
                            <span href="" className="font-semibold cursor-pointer mr-1 hover:underline">
                                Rhaenyra Targaryen
                            </span>
                        </Link>
                        <span className="mr-1">shared a</span>
                ...
                <div>
                    ...
                    {/* Logic for handling the button, that is when to trigger the dropdown menu */}
                    {/* When button is closed we will have the clicking functionality changing dropdownopen to true */}
                    {!dropdownOpen && (
                    ...
                    {/* But when dropdown is open the clickout functionality closes the button when clicking anywhere even on the button */}
                    {dropdownOpen && (
                        <button>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.75a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5ZM12 12.75a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5ZM12 18.75a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5Z" />
            ...
            <div className="flex gap-4 mt-4">
                ...
                <div className="border grow rounded-full relative">
                    <textarea className="h-12 p-3 overflow-hidden w-full roun gap-2 py-2ded-full" placeholder="Add a comment"></textarea>
