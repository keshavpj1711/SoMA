...
export default function NavigationCard() {
    ...
    const activeElement = 'flex gap-3 py-4 bg-socialBlue text-white -mx-10 rounded-md px-10 transition-all hover:shadow-md shadow-gray-300'
    ...
    return (
        <Card>
          <div className="px-4 py-2">
            ...
            {/* Conditions to only trigger the activeElement class when the pathName is required one */}
